...
public class PunchClockAdapter extends RecyclerView.Adapter<PunchClockAdapter.Holder> {
    ...
    public PunchClockAdapter(Context context, OnItemClickListener listener) {
    ...
    public void add(PunchClockBean bean) {
        if (bean != null) {
            beanList.add(bean);
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(context).inflate(R.layout.punch_detail_info, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.mPunchView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onPunchClick(bean);
            }
        });
        ...
        holder.mOperationMoreView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onHistoryClick(bean);
            }
        });
    }
    ...
    public static class Holder extends RecyclerView.ViewHolder {
        ...
        private ImageView mPunchView, mOperationMoreView;
        ...
        public Holder(@NonNull View itemView) {
            ...
            mPunchView = itemView.findViewById(R.id.punch_operation);
            mOperationMoreView = itemView.findViewById(R.id.operation_more);
        }
    }

    public interface OnItemClickListener {
        void onItemClick(PunchClockBean bean);
        void onPunchClick(PunchClockBean bean);
        void onHistoryClick(PunchClockBean bean);
    }
}
